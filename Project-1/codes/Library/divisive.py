...
class DivisiveClustering:
	...
	def initialize(self,dist_matrix):
		'''
		Initializer for the DivisiveClustering class.
		...
		self.i=0
		self.clusters[self.last_index]=[i for i in range(self.n)]
